...
(function(){
        ...
        start = function(CKEDITOR, elFinder) {
            ...
            $(function() {
                var elfNode, elfInsrance, dialogName,
                    elfUrl = '/views/admin/assets/elfinder/php/connector.minimal.php', // Your connector's URL
                ...
                CKEDITOR.replace('mytextarea', {
                    ...
                    filebrowserUploadUrl: '/views/admin/assets/elfinder/php/connector.minimal.php',
                    imageUploadUrl: '/views/admin/assets/elfinder/php/connector.minimal.php'
                });
    ...
    require.config({
        baseUrl : '/views/admin/assets/elfinder/js',
        paths : {
